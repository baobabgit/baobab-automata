...
from .epsilon_nfa_exceptions import ConversionError, EpsilonNFAError, InvalidEpsilonNFAError, InvalidEpsilonTransitionError
...
class EpsilonNFA(AbstractFiniteAutomaton):
    ...
    def __str__(self) -> str:
        ...
        :rtype: str
        """
        return f"ε-NFA(states={len(self._states)}, transitions={len(self._transitions)})"
