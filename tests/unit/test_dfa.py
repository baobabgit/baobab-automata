...
class TestDFA:
    ...
    def test_to_dict_with_transitions(self, sample_states, sample_alphabet, sample_transitions):
    ...
    def test_remove_state_removes_associated_transitions(self, sample_states, sample_alphabet, sample_transitions):
    ...
    def test_remove_transition(self, sample_states, sample_alphabet, sample_transitions):
