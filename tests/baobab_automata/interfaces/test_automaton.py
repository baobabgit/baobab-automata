...
class TestAutomatonWorkflow:
    ...
    def test_automaton_creation_workflow(self, sample_states, sample_alphabet, sample_transitions):
    ...
    def test_automaton_transition_management_workflow(self, sample_transitions, mock_automaton):
        ...
        mock_automaton.add_transition.assert_called_once_with(sample_transitions["symbol"])
        
        # Test de suppression de transition
        mock_automaton.remove_transition(sample_transitions["symbol"])
        mock_automaton.remove_transition.assert_called_with(sample_transitions["symbol"])
    
    def test_automaton_transition_queries_workflow(self, sample_states, sample_transitions, mock_automaton):
        """Test le workflow de requêtes de transitions."""
        # Configuration du mock
        mock_automaton.get_transitions_from.return_value = {sample_transitions["symbol"]}
        ...
        mock_automaton.get_transitions_from.assert_called_once_with(sample_states["initial"])
        ...
        mock_automaton.get_transitions_to.assert_called_once_with(sample_states["final"])
        ...
        mock_automaton.get_transitions.assert_called_once_with(sample_states["initial"], "a")
    ...
    def test_automaton_representation_workflow(self, mock_automaton):
        ...
        mock_automaton.__repr__ = Mock(return_value="DFA(automaton_type='dfa', states=2)")
...
class TestAutomatonIntegration:
    ...
    def test_complete_automaton_workflow(self, sample_states, sample_alphabet, sample_transitions):
    ...
    def test_automaton_error_handling_workflow(self, mock_automaton):
        ...
        mock_automaton.validate.return_value = ["No initial states", "Invalid transition"]
