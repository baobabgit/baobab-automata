...
class TestLanguageOperations(unittest.TestCase):
    ...
    def test_validate_operation_valid(self):
        ...
        self.assertTrue(self.operations.validate_operation('union', self.dfa1, self.dfa2))
    ...
    def test_validate_operation_invalid_parameters(self):
        ...
        self.assertFalse(self.operations.validate_operation('union', "invalid", self.dfa2))
        self.assertFalse(self.operations.validate_operation('union', self.dfa1, "invalid"))
