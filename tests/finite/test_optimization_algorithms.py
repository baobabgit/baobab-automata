...
from baobab_automata.finite.optimization_algorithms import OptimizationAlgorithms, OptimizationStats
...
class TestOptimizationAlgorithms:
    ...
    def test_reduce_epsilon_transitions(self):
        ...
        epsilon_nfa = EpsilonNFA(states, alphabet, transitions, initial_state, final_states)
        optimizer = OptimizationAlgorithms()
