#!/usr/bin/env python3
"""Script de débogage détaillé pour les DPDA."""
...
def debug_dpda():
    ...
    while True:
        ...
        if current_config.is_accepting and dpda.is_final_state(current_config.state):
            print("✓ Mot accepté !")
            break
        ...
        if transition is None and input_symbol:
            transition = dpda.get_transition(
                current_config.state, 
                '', 
                stack_symbol
